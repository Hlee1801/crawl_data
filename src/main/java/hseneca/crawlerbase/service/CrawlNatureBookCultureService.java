...
@Service
public class CrawlNatureBookCultureService {

    @Autowired
    private RecordRepository recordRepository;

    @Transactional
    public void crawlNatureBookAndCulture(Integer page) throws IllegalAccessError, IOException {
        String url = "https://www.nature.com/books-culture?page=" + page;
        try {
